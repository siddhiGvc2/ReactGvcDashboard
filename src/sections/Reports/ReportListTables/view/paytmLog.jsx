...
import PaytmLogRow from '../paytmLog-row';
...
export default function PaytmLogView({users}) {
            ...
            <Table sx={{ minWidth: 800 }} ref={tblDataRef}>
              <UserTableHead
                ...
                headLabel={[
                  { id: 'id', label: 'Sr.No' },
                  { id: 'mid', label: 'MID' },
                  { id: 'custId', label: 'AMOUNT' },
                  { id: 'custId', label: 'CUST ID' },
                  { id: 'custId', label: 'ORDER ID' },
                  { id: 'custId', label: 'TXN ID' },
                  { id: 'custId', label: 'MOB NUMBER' },
