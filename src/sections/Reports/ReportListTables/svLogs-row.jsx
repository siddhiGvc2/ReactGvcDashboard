...
export default function SvLogRow({
  sr,
  selected,
  name,
  email,
  ...
  return (
    <>
      <TableRow hover tabIndex={-1} role="checkbox" selected={selected} >
       ...
       <TableCell align="center">{row.simulatedQty}</TableCell>
       <TableCell align="center">{row.simulatedCycles}</TableCell>
       <TableCell align="center">{row.Zones}</TableCell>
       <TableCell align="center">{row.Wards}</TableCell>
