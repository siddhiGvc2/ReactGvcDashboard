...
marker.bindPopup(`
       <b style="font-size: 1.25em;">${location.data.userName}</b>
       <table class="table">
       <tbody>
           <tr>
...
const LoadData=useCallback((time)=>{
    ...
    //   console.log(filteredUserCheckOut);
     ...
     LoadMap(center,locations,filteredUserLastCheckIn,filteredUserLogOut,filteredUserLogIn,filteredUserCheckOut);
